...
<body>
  ...
  <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="img/slider/slide01.jpg" alt="First slide">
            <div class="carousel-caption">
                <p class="slider-text">strongest distribution network</p>
            </div>
        </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/slider/slide02.jpg" alt="Second slide">
      <div class="carousel-caption">
                <p class="slider-text">International Air Freight</p>
            </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/slider/slide03.jpg" alt="Third slide">
      <div class="carousel-caption">
                <p class="slider-text">Road Freight Services</p>
            </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/slider/slide04.jpg" alt="Forth slide">
      <div class="carousel-caption">
                <p class="slider-text">Trucking</p>
            </div>
    </div>
